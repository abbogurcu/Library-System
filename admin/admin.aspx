<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="ERU_Lib.admin.admin" %>
...
<body class="g-sidenav-show g-sidenav-pinned bg-primary">
  ...
  <div class="main-content" id="panel">
    ...
    <!-- Page content -->
    <div class="container" style="margin-top:50px;width:90%;margin-left:auto;margin-right:auto;background-color:#ebebeb;box-shadow: 0 2px 4px 0 rgba(0,0,0,.6);">
        <div class="col-md-12">
            <div class="row justify-content-between" style="padding:50px 0px;">
                <div class="col-md-5" runat="server" style="padding:15px 20px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.6);">
                    <h3>Kategoriler</h3>
                    ...
                    <div runat="server" class="form-group mb-3">
                      <div class="input-group input-group-alternative">
                        ...
                        <asp:Dropdownlist id="DropDownList1" AutoPostBack="true" OnSelectedIndexChanged="OnSelectedIndexChanged" class="form-control" type="text" runat="server">
                          </asp:Dropdownlist>
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                          <strong>
                            <asp:Label ID="Label1" runat="server" Text="Bu isimde bir kategori zaten mevcut." CssClass="alert alert-warning" style="display:none;"></asp:Label>
                            <asp:Label ID="Label2" runat="server" Text="Kategori eklendi." CssClass="alert alert-success" style="display:none;"></asp:Label>
                            <asp:Label ID="Label3" runat="server" Text="Kategori güncellendi." CssClass="alert alert-warning" style="display:none;"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Text="Kategori silindi." CssClass="alert alert-danger" style="display:none;"></asp:Label>
                            <asp:Label ID="Label10" runat="server" Text="Bilgiler boş geçilemez." CssClass="alert alert-warning" style="display:none;"></asp:Label>
                          </strong>
                    </div>
                ...
                <!--- Masa -->
                <div class="col-md-5" style="padding:15px 10px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.6);">
                    <h3>Masalar</h3>
                    ...
                    <div runat="server" class="form-group mb-3">
                      <div class="input-group input-group-alternative">
                        ...
                        <asp:Dropdownlist id="DropDownList2" AutoPostBack="true" OnSelectedIndexChanged="OnSelectedIndexChanged2" class="form-control" type="text" runat="server">
                          </asp:Dropdownlist>
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                          <strong>
                            <asp:Label ID="Label5" runat="server" Text="Bu isimde bir masa zaten mevcut." CssClass="alert alert-warning" style="display:none;"></asp:Label>
                            <asp:Label ID="Label6" runat="server" Text="Masa eklendi." CssClass="alert alert-success" style="display:none;"></asp:Label>
                            <asp:Label ID="Label7" runat="server" Text="Masa güncellendi." CssClass="alert alert-warning" style="display:none;"></asp:Label>
                            <asp:Label ID="Label8" runat="server" Text="Masa silindi." CssClass="alert alert-danger" style="display:none;"></asp:Label>
                            <asp:Label ID="Label9" runat="server" Text="Bilgiler boş geçilemez." CssClass="alert alert-warning" style="display:none;"></asp:Label>
                          </strong>
                    </div>

                    <div id="Div1" visible="false" runat="server">
                        <button class="btn btn-success float-left" runat="server" onserverclick="addBtn2">Ekle</button>
                    </div>
                    <div id="Div2" visible="false" runat="server">
                        <button class="btn btn-primary float-left" runat="server" onserverclick="updateBtn2">Güncelle</button>
                        <button class="btn btn-warning float-right" runat="server" onserverclick="deleteBtn2">Sil</button>
                    </div>
                </div>
            </div>
        </div>
